...
#ifndef PHILIPSGOEASYLIBRARY_SWIFT_H
#define PHILIPSGOEASYLIBRARY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PhilipsGoEasyLibrary",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC20PhilipsGoEasyLibrary16DeviceBindStatus")
...
+ (PHLPairManager * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (void)connectDeviceWiFi:(NSString * _Nonnull)ssid complete:(void (^ _Nonnull)(id _Nonnull, SDKError * _Nonnull))complete;
- (void)connectManual:(NSString * _Nonnull)ssid complete:(void (^ _Nonnull)(id _Nonnull, SDKError * _Nonnull))complete;
- (void)requestCheckMastercode:(NSString * _Nonnull)mastercode complete:(void (^ _Nonnull)(id _Nonnull, SDKError * _Nonnull))complete;
- (void)requestChangeMastercode:(NSString * _Nonnull)mastercode complete:(void (^ _Nonnull)(id _Nonnull, SDKError * _Nonnull))complete;
- (void)requestWifiListWithComplete:(void (^ _Nonnull)(BOOL, NSArray * _Nullable))complete;
- (void)requestWifiConfig:(WiFILockWiFiListModel * _Nonnull)hotspot password:(NSString * _Nonnull)password complete:(void (^ _Nonnull)(id _Nonnull, SDKError * _Nonnull))complete;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC20PhilipsGoEasyLibrary8SDKError")
...
SWIFT_CLASS("_TtC20PhilipsGoEasyLibrary21WiFILockWiFiListModel")
@interface WiFILockWiFiListModel : ResultModel
